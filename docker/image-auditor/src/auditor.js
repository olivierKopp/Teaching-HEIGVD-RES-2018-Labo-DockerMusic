...
var musicianUuid = payload.uuid;
var musician = musicians.get(musicianUuid);

//if the musician doesn't exist, we put it in the map
if(musician == undefined){
	musicians.set( musicianUuid, {"instrument" : payload.instrument, "activeSince" : payload.activeSince, "timeout" : setTimeout(removeMusician,5000,musicianUuid)} );
}
